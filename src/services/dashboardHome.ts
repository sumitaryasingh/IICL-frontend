...
export const addCourse = async (course: Course): Promise<Course> => {
  try {
    const response = await axioInstance.post<Course>("/api/course/add-course", course);
...
export const getCourses = async (): Promise<Course[]> => {
  try {
    const response = await axioInstance.get<Course[]>("/api/course/get-course");
    return response.data;
  } catch (error: any) {
...
export const updateCourse = async (courseId: string, course: Course): Promise<Course> => {
  try {
    const response = await axioInstance.put<Course>(`/api/course/${courseId}`, course);
    return response.data;
  } catch (error: any) {
...
export const deleteCourse = async (courseId: string): Promise<{ message: string }> => {
  try {
    const response = await axioInstance.delete<{ message: string }>(`/api/course/delete-course/${courseId}`);
    return response.data;
  } catch (error: any) {
